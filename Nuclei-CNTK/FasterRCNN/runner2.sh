...
time CUDA_VISIBLE_DEVICES=5 python3 run_faster_rcnn_VGG16.py SigmaCenter/Center0_5/SigRPN1/SigDET1_5 1 1.5 > Output/SigmaCenter/Center0_5/SigRPN1/OutputSigDET1_5.txt 2> Output/SigmaCenter/Center0_5/SigRPN1/errSigDET1_5.txt &
...
time CUDA_VISIBLE_DEVICES=5 python3 run_faster_rcnn_VGG16.py SigmaCenter/Center0_5/SigRPN1/SigDET10 1 10 > Output/SigmaCenter/Center0_5/SigRPN1/OutputSigDET10.txt 2> Output/SigmaCenter/Center0_5/SigRPN1/errSigDET10.txt &
