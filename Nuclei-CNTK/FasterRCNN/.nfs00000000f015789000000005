...
time CUDA_VISIBLE_DEVICES=3 python3 run_faster_rcnn_VGG16.py SigmaCenter/Center10/0_01 0.01 > Output/SigmaCenter/Center10/Out/0_01.txt 2> Output/SigmaCenter/Center10/Err/0_01.txt &
wait
time CUDA_VISIBLE_DEVICES=3 python3 run_faster_rcnn_VGG16.py SigmaCenter/Center10/0_1 0.1 > Output/SigmaCenter/Center10/Out/0_1.txt 2> Output/SigmaCenter/Center10/Err/0_1.txt &
wait
time CUDA_VISIBLE_DEVICES=3 python3 run_faster_rcnn_VGG16.py SigmaCenter/Center10/1 1 > Output/SigmaCenter/Center10/Out/1.txt 2> Output/SigmaCenter/Center10/Err/1.txt &
wait
time CUDA_VISIBLE_DEVICES=3 python3 run_faster_rcnn_VGG16.py SigmaCenter/Center10/10 10 > Output/SigmaCenter/Center10/Out/10.txt 2> Output/SigmaCenter/Center10/Err/10.txt &
wait
time CUDA_VISIBLE_DEVICES=3 python3 run_faster_rcnn_VGG16.py SigmaCenter/Center10/100 100 > Output/SigmaCenter/Center10/Out/100.txt 2> Output/SigmaCenter/Center10/Err/100.txt &
