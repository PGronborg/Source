...
time CUDA_VISIBLE_DEVICES=5 python3 run_faster_rcnn_VGG16.py SigmaCenter/Center100/0_01 0.01 > Output/SigmaCenter/Center100/Out/0_01.txt 2> Output/SigmaCenter/Center100/Err/0_01.txt &
wait
time CUDA_VISIBLE_DEVICES=5 python3 run_faster_rcnn_VGG16.py SigmaCenter/Center100/0_1 0.1 > Output/SigmaCenter/Center100/Out/0_1.txt 2> Output/SigmaCenter/Center100/Err/0_1.txt &
wait
time CUDA_VISIBLE_DEVICES=5 python3 run_faster_rcnn_VGG16.py SigmaCenter/Center100/1 1 > Output/SigmaCenter/Center100/Out/1.txt 2> Output/SigmaCenter/Center100/Err/1.txt &
wait
time CUDA_VISIBLE_DEVICES=5 python3 run_faster_rcnn_VGG16.py SigmaCenter/Center100/10 10 > Output/SigmaCenter/Center100/Out/10.txt 2> Output/SigmaCenter/Center100/Err/10.txt &
wait
time CUDA_VISIBLE_DEVICES=5 python3 run_faster_rcnn_VGG16.py SigmaCenter/Center100/100 100 > Output/SigmaCenter/Center100/Out/100.txt 2> Output/SigmaCenter/Center100/Err/100.txt &
