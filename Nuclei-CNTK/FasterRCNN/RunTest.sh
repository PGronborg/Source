...
time CUDA_VISIBLE_DEVICES=5 python3 run_faster_rcnn_VGG16.py Layers/Last_conv_relu4_3 > Output/Layers/Last_conv_relu4_3Out.txt 2> Output/Layers/Last_conv_relu4_3Err.txt &
