...
time CUDA_VISIBLE_DEVICES=5 python3 run_faster_rcnn_VGG16.py Layers/Start_conv1_1 > Output/Layers/Start_conv1_1Out.txt 2> Output/Layers/Start_conv1_1Err.txt &
