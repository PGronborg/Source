...
time CUDA_VISIBLE_DEVICES=0 python3 run_faster_rcnn_VGG16.py SigmaCenter/Center_01/0_01 0.01 > Output/SigmaCenter/Center_01/Out/0_01.txt 2> Output/SigmaCenter/Center_01/Err/0_01.txt &
