...
#time CUDA_VISIBLE_DEVICES=4 python3 run_faster_rcnn_VGG16.py SigmaCenter/Center1/10 10.0 > Output/SigmaCenter/Center1/Out/10.txt 2> Output/SigmaCenter/Center1/Err/10.txt &
