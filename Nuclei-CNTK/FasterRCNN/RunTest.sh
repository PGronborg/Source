...
time CUDA_VISIBLE_DEVICES=4 python3 run_faster_rcnn_VGG16.py SigmaCenter/Center_1/10 10.0 > Output/SigmaCenter/Center_1/Out/10.txt 2> Output/SigmaCenter/Center_1/Err/10.txt &
time CUDA_VISIBLE_DEVICES=5 python3 run_faster_rcnn_VGG16.py SigmaCenter/Center_1/100 100.0 > Output/SigmaCenter/Center_1/Out/100.txt 2> Output/SigmaCenter/Center_1/Err/100.txt &
