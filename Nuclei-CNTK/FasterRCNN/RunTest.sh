...
time CUDA_VISIBLE_DEVICES=0 python3 run_faster_rcnn_VGG16.py Ref/Ref_L2_0005_1 > Output/Ref/Ref_L2_0005_1Out.txt 2> Output/Ref/Ref_L2_0005_1Err.txt &
time CUDA_VISIBLE_DEVICES=1 python3 run_faster_rcnn_VGG16.py Ref/Ref_L2_0005_2 > Output/Ref/Ref_L2_0005_2Out.txt 2> Output/Ref/Ref_L2_0005_2Err.txt &
