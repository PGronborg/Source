...
#plt.plot(count, train_err, 'r-'),plt.text(np.percentile(count,70.0), 90,'-- Training error',{'color': 'r','fontsize': 11})
#plt.plot(count, val_err, 'b-'),plt.text(np.percentile(count,70.0), 85,'-- Validation error',{'color': 'b','fontsize': 11})

plt.plot(count, train_loss, 'r-'),plt.text(np.percentile(count,70.0), 0.90,'-- Training Loss',{'color': 'r','fontsize': 11})
